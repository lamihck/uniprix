...
/**
 * Servlet implementation class ListeLigneCommandeServlet
 */
public class ListeLigneCommandeServlet extends BaseServlet {
     ...
     */
    public ListeLigneCommandeServlet() {
        super();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher dispath = request.getRequestDispatcher("lignecommandeAdmin.jsp");

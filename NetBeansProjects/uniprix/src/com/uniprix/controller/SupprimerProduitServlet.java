 ...
 */
public class SupprimerProduitServlet extends BaseServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (request.getParameter("produitId") != null
            ...
            RequestDispatcher dispath = request.getRequestDispatcher("supprimerProduit.jsp");
            dispath.forward(request, response);
        } else if (request.getParameter("idProd") != null) {

            if (request.getParameter("group1").equals("Oui")) {
                produitDAO.delete(Integer.parseInt(request.getParameter("idProd")));
            }
